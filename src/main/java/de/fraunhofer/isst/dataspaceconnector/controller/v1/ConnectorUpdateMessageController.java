...
import static de.fraunhofer.isst.dataspaceconnector.utils.ControllerUtils.sendingConnectorUpdateMessageFailed;
...
public class ConnectorUpdateMessageController {
    ...
    public ResponseEntity<Object> sendConnectorUpdateMessage(
        ...
        try {
            ...
            return sendingConnectorUpdateMessageFailed(exception);
        }
    }
}
