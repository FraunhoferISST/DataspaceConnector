...
public final class RelationControllers {
    ...
    public static class RulesToContracts extends BaseResourceChildController<RelationshipServices.RuleContractLinker, Contract, ContractView> {
    }
    ...
    public static class ArtifactsToRepresentations extends BaseResourceChildController<RelationshipServices.ArtifactRepresentationLinker, Representation, RepresentationView> {
    }
    ...
    public static class RepresentationsToOfferedResources extends BaseResourceChildController<RelationshipServices.RepresentationOfferedResourceLinker, OfferedResource, OfferedResourceView> {
    }
    ...
    public static class RepresentationsToRequestedResources extends BaseResourceChildController<RelationshipServices.RepresentationOfferedResourceLinker, RequestedResource, RequestedResourceView> {
    }

    @RestController
    @RequestMapping("/api/offers/{id}/catalogs")
    @Tag(name = "Resources", description = "Endpoints for linking offered resources to catalogs")
    public static class OfferedResourcesToCatalogs extends BaseResourceChildController<RelationshipServices.OfferedResourceCatalogLinker, Catalog, CatalogView> {
    }
    ...
    public static class RequestedResourcesToCatalogs extends BaseResourceChildController<RelationshipServices.RequestedResourceCatalogLinker, Catalog, CatalogView> {
    }

    @RestController
    @RequestMapping("/api/contracts/{id}/offers")
    @Tag(name = "Contracts", description = "Endpoints for linking contracts to offers")
    public static class ContractsToOfferedResources extends BaseResourceChildController<RelationshipServices.ContractOfferedResourceLinker, OfferedResource, OfferedResourceView> {
    }

    @RestController
    @RequestMapping("/api/contracts/{id}/requests")
    @Tag(name = "Contracts", description = "Endpoints for linking contracts to requests")
    public static class ContractsToRequestedResources extends BaseResourceChildController<RelationshipServices.ContractRequestedResourceLinker, RequestedResource, RequestedResourceView> {
    }
