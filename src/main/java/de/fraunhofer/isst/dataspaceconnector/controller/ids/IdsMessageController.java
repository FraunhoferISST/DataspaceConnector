...
//            // Failed to sendMessage the description request message.
//            LOGGER.info(
//                    "Failed to sendMessage or build a request. [exception=({})]", exception.getMessage());
//            return new ResponseEntity<>("Failed to sendMessage description request message.",
...
//        } catch (MessageBuilderException exception) {
//            // Failed to sendMessage the contract request message.
//            LOGGER.info(
//                    "Failed to sendMessage or build a request. [exception=({})]", exception.getMessage());
//            return new ResponseEntity<>(
//                    "Failed to sendMessage contract request message.", HttpStatus.INTERNAL_SERVER_ERROR);
//        } catch (MessageResponseException exception) {
...
//            // Failed to sendMessage contract agreement confirmation.
//            LOGGER.info(
//                    "Failed to sendMessage contract agreement. [exception=({})]", exception.getMessage());
...
//                    "Failed to sendMessage or build a request. [exception=({})]", exception.getMessage());
//            return new ResponseEntity<>(
//                    "Failed to sendMessage artifact request message.", HttpStatus.INTERNAL_SERVER_ERROR);
//        } catch (MessageResponseException exception) {
