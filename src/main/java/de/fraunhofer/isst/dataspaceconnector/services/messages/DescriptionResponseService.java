 ...
 */
@Service
public final class DescriptionResponseService extends MessageService<DescriptionResponseDesc> {

    @Override
    public Message buildMessage(final DescriptionResponseDesc desc) throws ConstraintViolationException {
