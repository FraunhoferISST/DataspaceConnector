...
class IdsCatalogBuilder extends AbstractIdsBuilder<Catalog, ResourceCatalog> {

    private final @NonNull IdsOfferedResourceBuilder resourceBuilder;
    ...
    protected ResourceCatalog createInternal(final Catalog catalog, final URI baseUri,
        ...
        // Build children.
        final var resources = create(resourceBuilder, catalog.getOfferedResources(), baseUri,
