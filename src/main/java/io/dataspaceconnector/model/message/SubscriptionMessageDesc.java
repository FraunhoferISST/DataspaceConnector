...
public class SubscriptionMessageDesc extends MessageDesc {

    /**
     * The id of the subscribed element.
     */
    private URI target;
     ...
     */
    public SubscriptionMessageDesc(final URI recipient, final URI elementId) {
        super(recipient);
