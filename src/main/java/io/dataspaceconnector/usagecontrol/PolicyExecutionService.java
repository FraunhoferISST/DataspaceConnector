...
import io.dataspaceconnector.ids.messages.LogMessageService;
import io.dataspaceconnector.ids.messages.NotificationService;
    ...
    public void sendAgreement(final ContractAgreement agreement) {
        try {
            ...
            if (!recipient.equals(URI.create(""))) {
                logMessageService.sendMessage(recipient, RdfUtils.toRdf(agreement));
            }
