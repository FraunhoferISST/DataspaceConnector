 ...
 */
package io.dataspaceconnector.usagecontrol.util;
...
import static io.dataspaceconnector.usagecontrol.util.RuleUtils.comparePermissions;
import static io.dataspaceconnector.usagecontrol.util.RuleUtils.compareProhibitions;
...
public final class ContractUtils {
     ...
     */
    public static List<io.dataspaceconnector.model.core.Contract> removeContractsWithInvalidConsumer(
            final List<io.dataspaceconnector.model.core.Contract> contracts,
    ...
    public static boolean isMatchingTransferContract(final List<Artifact> artifacts,
        ...
        // TODO Compare based on URI
        return artifacts.parallelStream()
                           .filter(x -> requestedArtifact.toString().contains(x.getId().toString()))
                           .count() > 0;
