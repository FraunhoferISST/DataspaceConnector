...
public class ClearingHouseLoggingProcessor implements Processor {
    ...
    public void process(final Exchange exchange) throws Exception {
        ...
        var transferContractID = UUIDUtils.uuidFromUri(idsMessageHeader.getTransferContract());
        final var clearingHouse = connectorConfig.getClearingHouse();
        if (!clearingHouse.equals(URI.create(""))) {
            logMessageService.sendMessage(URI.create(clearingHouse + transferContractID.toString()),
