...
public class ProjectInformationServiceTest {
    ...
    @Test
    public void testGetLatestReleaseVersion() throws IOException {
        /* ARRANGE */
        var mockResponse = new MockResponse()
                .setResponseCode(200)
                .setBody(RESPONSE_STRING);
        final var projectVersion = "6.2.0";

        mockWebServer.enqueue(mockResponse);
        Assertions.assertEquals(projectVersion, projectInformationService.getLatestReleaseVersion());
    }
}
