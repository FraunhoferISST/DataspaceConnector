...
public class ArtifactUpdaterTest {
    ...
    private final io.dataspaceconnector.model.core.Artifact dscArtifact        = getDscArtifact();
    private final io.dataspaceconnector.model.core.Artifact dscUpdatedArtifact = getUpdatedDscArtifact();
    ...
    private io.dataspaceconnector.model.core.Artifact getDscArtifact() {
        final var output = new ArtifactImpl();
        ReflectionTestUtils.setField(output, "title", "SOME TITLE");
        return output;
    }

    private io.dataspaceconnector.model.core.Artifact getUpdatedDscArtifact() {
        final var output = new ArtifactImpl();
