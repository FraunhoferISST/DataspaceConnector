...
public class RepresentationUpdaterTest {
    ...
    private final io.dataspaceconnector.model.core.Representation dscRepresentation        = getDscRepresentation();
    private final io.dataspaceconnector.model.core.Representation dscUpdatedRepresentation = getUpdatedDscRepresentation();
    ...
    private io.dataspaceconnector.model.core.Representation getDscRepresentation() {
        final var output = new io.dataspaceconnector.model.core.Representation();
        ReflectionTestUtils.setField(output, "language", "SOME Language");
        return output;
    }

    private io.dataspaceconnector.model.core.Representation getUpdatedDscRepresentation() {
        final var output = new io.dataspaceconnector.model.core.Representation();
