 ...
 */
package io.dataspaceconnector.ids.messages.dto;
...
public class ContractRejectionMessageDescTest {
    @Test
    public void defaultConstructor_nothing_emptyDesc() {
        ...
        /* ACT */
        final var result = new ContractRejectionMessageDesc();
    ...
    public void allArgsConstructor_valid_validDesc() {
        ...
        /* ACT */
        final var result = new ContractRejectionMessageDesc(recipient, message);
    ...
    public void equals_everything_valid() {
        EqualsVerifier.simple().forClass(ContractRejectionMessageDesc.class).verify();
    }
}
