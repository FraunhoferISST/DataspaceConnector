 ...
 */
package io.dataspaceconnector.controller.resources.identityprovider;
...
class IdentityProviderControllerIT {
    ...
    void create_validInput_returnNew() throws Exception {
        mockMvc.perform(post("/api/identityproviders")
    ...
    void getAll_validInput_returnObj() throws Exception {
        ...
        mockMvc.perform(get("/api/identityproviders")).andExpect(status().isOk());
    }
