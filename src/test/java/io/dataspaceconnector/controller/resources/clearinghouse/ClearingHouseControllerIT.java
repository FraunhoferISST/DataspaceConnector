package io.dataspaceconnector.controller.resources.clearinghouse;
...
class ClearingHouseControllerIT {
    ...
    void create_validInput_returnNew() throws Exception {
        mockMvc.perform(post("/api/clearinghouses")
    ...
    void getAll_validInput_returnObj() throws Exception {
        ...
        mockMvc.perform(get("/api/clearinghouses")).andExpect(status().isOk());
    }
