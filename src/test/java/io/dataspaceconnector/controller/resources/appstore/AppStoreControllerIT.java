package io.dataspaceconnector.controller.resources.appstore;
...
class AppStoreControllerIT {
    ...
    void create_validInput_returnNew() throws Exception {
        mockMvc.perform(post("/api/appstores")
    ...
    void getAll_validInput_returnObj() throws Exception {
        ...
        mockMvc.perform(get("/api/appstores")).andExpect(status().isOk());
    }
