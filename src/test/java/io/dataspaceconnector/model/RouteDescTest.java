...
public class RouteDescTest {
    ...
    public void equals_verify() {
        ...
        route.setRouteConfiguration("First Configuration");

        final var secondRoute = new Route();
        secondRoute.setRouteConfiguration("Second Configuration");
        ...
        EqualsVerifier.simple().forClass(RouteDesc.class)
                .withPrefabValues(Route.class, route,secondRoute)
