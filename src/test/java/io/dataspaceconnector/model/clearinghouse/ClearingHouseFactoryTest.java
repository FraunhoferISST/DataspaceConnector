...
public class ClearingHouseFactoryTest {

    final ClearingHouseDesc desc = new ClearingHouseDesc();
    final ClearingHouseFactory factory = new ClearingHouseFactory();

    @Test
    void create_validDesc_returnNew() {
        /* ARRANGE */
        final var title = "ClearingHouse";
        desc.setTitle(title);
