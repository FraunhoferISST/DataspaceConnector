...
public class ProcessCreationMessageDescTest {

    @Test
    void defaultConstructor_nothing_emptyDesc() {
        /* ACT */
        final var result = new ProcessCreationMessageDesc();
    ...
    void allArgsConstructor_valid_validDesc() {
        ...
        /* ACT */
        final var result = new ProcessCreationMessageDesc(recipient);
    ...
    void equals_everything_valid() {
        EqualsVerifier.simple().forClass(ProcessCreationMessageDesc.class).verify();
    }
