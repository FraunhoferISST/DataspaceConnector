...
public class IdentityProviderFactoryTest {
    ...
    final IdentityProviderDesc desc = new IdentityProviderDesc();
    final IdentityProviderFactory factory = new IdentityProviderFactory();

    @Test
    void create_validDesc_returnNew() {
        /* ARRANGE */
        final var title = "IdentityProvider";
        desc.setTitle(title);
