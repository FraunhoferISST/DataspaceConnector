...
import io.configmanager.extensions.gui.api.controller.GuiUtilController;
 ...
 */
@SpringBootTest(classes = {GuiUtilService.class, GuiUtilController.class, GuiUtilApi.class})
@AutoConfigureMockMvc
class GuiUtilControllerTest {
