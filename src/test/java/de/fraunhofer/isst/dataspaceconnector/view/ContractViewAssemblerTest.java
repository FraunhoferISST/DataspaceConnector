...
public class ContractViewAssemblerTest {
    ...
    public void toModel_noResources_returnContractViewWithOffersLink() {
        ...
        /* ASSERT */
        assertNotNull(result);
        assertEquals(contract.getTitle(), result.getTitle());
        assertEquals(contract.getStart(), result.getStart());
        assertEquals(contract.getEnd(), result.getEnd());
        assertEquals(contract.getConsumer(), result.getConsumer());
        assertEquals(contract.getCreationDate(), result.getCreationDate());
        assertEquals(contract.getModificationDate(), result.getModificationDate());
        assertEquals(contract.getAdditional(), result.getAdditional());
    ...
    private String getContractRulesLink(final UUID contractId) {
        return linkTo(methodOn(RelationControllers.ContractsToRules.class)
