...
COPY public.authentication (dtype, id, deleted, password, username, key, value) FROM stdin;
\.
...
COPY public.configuration (id, bootstrap_id, created_date, deleted, modified_date, description, title, active, curator, default_endpoint, deploy_mode, log_level, maintainer, outbound_model_version, security_profile, status, version, keystore_id, proxy_id, truststore_id) FROM stdin;
44df0458-30ab-4676-bb54-b4accb619117	\N	2021-10-08 12:16:38.153547	f	2021-10-08 12:16:38.153565	IDS Connector with static example resources hosted by the Fraunhofer ISST	Dataspace Connector	t	https://www.isst.fraunhofer.de/	https://localhost:8080/api/ids/data	TEST	WARN	https://www.isst.fraunhofer.de/	4.1.0	BASE_SECURITY	\N	6.0.0	3899e999-6d05-4d16-88e7-825355227b1e	\N	fce8f259-5112-45e7-a37f-a60c15685074
\.
...
44df0458-30ab-4676-bb54-b4accb619117	4.0.0
44df0458-30ab-4676-bb54-b4accb619117	4.1.0
\.
...
COPY public.data (dtype, id, deleted, access_url, value) FROM stdin;
\.
...
COPY public.keystore (id, bootstrap_id, created_date, deleted, modified_date, location, password) FROM stdin;
3899e999-6d05-4d16-88e7-825355227b1e	\N	2021-10-08 12:16:38.143635	f	2021-10-08 12:16:38.143659	file:///conf/keystore-localhost.p12
\.
...
COPY public.resource (dtype, id, bootstrap_id, created_date, deleted, modified_date, description, title, endpoint_documentation, language, license, publisher, sovereign, version, remote_id) FROM stdin;
\.
...
COPY public.truststore (id, bootstrap_id, created_date, deleted, modified_date, location, password) FROM stdin;
fce8f259-5112-45e7-a37f-a60c15685074	\N	2021-10-08 12:16:38.152088	f	2021-10-08 12:16:38.152107	file:///conf/truststore.p12
\.
